  ...
  return (
    <section id="problem" className="relative py-24 lg:py-28">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
          ...
          {costs.map((c, i) => {
            ...
            return (
              <Reveal key={c.title} delay={((i + 1) as 1 | 2 | 3)}>
                <div className="group h-full rounded-2xl border border-ink-100 bg-white p-7 shadow-sm transition-all hover:-translate-y-1 hover:border-brand-200 hover:shadow-xl hover:shadow-ink-900/5">
        ...
        <Reveal delay={2}>
          <div className="mt-16 grid overflow-hidden rounded-3xl border border-ink-100 shadow-sm md:grid-cols-2">
